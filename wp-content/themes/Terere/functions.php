...
wp_register_script( 'jquery-ui', get_template_directory_uri ()  . '/js/jquery-1.10.2.js');
} 


add_action('init', 'init_jquery', 'init_jquery_ui');
...
/* REGISTRAR MENU PERSONALIZADO */
function register_my_menu() {
  register_nav_menu('menu-terere',__( 'Menu' ));
}
add_action( 'init', 'register_my_menu' );


/**** REGISTRAR VÁRIOS MENUS PERSONALIZADOS ***/
